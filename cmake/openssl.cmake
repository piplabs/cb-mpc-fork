...
macro(link_openssl TARGET_NAME)
  ...
  if(IS_WASM)
    # Override default OpenSSL path for WASM if user didn't explicitly set it
    if(CBMPC_OPENSSL_ROOT STREQUAL "/usr/local/opt/openssl@3.2.0")
      set(CBMPC_OPENSSL_ROOT "${ROOT_DIR}/vendors/openssl-wasm")
    endif()
